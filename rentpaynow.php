<?php
    ...
    if(isset($_POST['submit2'])){   
        ...
        $payingamount= $rent_hour * $price;
            ...
            $sql="INSERT INTO client_rent (client_name,email,phone,nationalid,rent_datetime,rent_hour,starting_address,destination_address,crsku,paying_amount,status) VALUES('{$client_name}','{$_SESSION['SESSION_EMAIL']}','{$phone}','{$nationalid}','{$rent_datetime}','{$rent_hour}','{$starting_address}','{$destination_address}','{$crsku}','{$payingamount}','Pending') ";
            $result= mysqli_query($conn, $sql);
            if ($result) {
                header('Location: rentstatus.php');
            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <form action="rentpaynow.php" method="post"  > 
