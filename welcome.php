...
<section class="section platforms" id="platforms">
        ...
        <section class="section-center featured-center">
            <!-- sort -->
            <form action="welcome.php #platforms" method="GET">
                        <div >
                            ...
                            <button type="sort" class="btn-primary" >Sort</button>
                        </div>
            </form>
            <!-- end of sort -->
            <!-- featured center -->
            <div class="section-center featured-center" id="responsedata">
                <?php
                $sort_option="";
	            if(isset($_GET['sort'])){
                ...
                if(mysqli_num_rows($result)>0){
                    foreach($result as $rws){
                        ...
                        <article class="art-card">
                            <!-- img container -->
                            <a href="buycar.php?csku=<?php echo $rws['csku'] ?>"   class="art-img-container">
                            ...
                            <div class="art-footer">
                                ...
                                <div class="art-info">
                                    ...
                                    <div class="art-link">
                                        <a href="buycar.php?csku=<?php echo $rws['csku'] ?>"  class="btn-primary">Buy Now</a>
                                    </div>
                                </div>
    ...
    <section class="section featured" id="featured">
        ...
        <!-- sort -->
        <form action="welcome.php #featured"  method="GET">
                        <div  >
                            <select name="sort" class="form-control">
        ...
        <?php
                ...
                if(mysqli_num_rows($result)>0){
                    foreach($result as $rws){
                        ...
                        <article class="art-card">
                            <!-- img container -->
                            <a href="rentcar.php?crsku=<?php echo $rws['crsku'] ?>"   class="art-img-container">
                            ...
                            <div class="art-footer">
                                ...
                                <div class="art-info">
                                    ...
                                    <div class="art-link">
                                        <a href="rentcar.php?crsku=<?php echo $rws['crsku'] ?>"  class="btn-primary">Rent Now</a>
                                    </div>
                                </div>
    ...
    <section class="section contact" id="contact">
        ...
        <?php echo $msg; ?>
        <!--end of title-->
        <form action="welcome.php #contact" method="post">
