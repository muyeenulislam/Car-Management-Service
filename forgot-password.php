    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM user WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {        
            ...
            $mail = new PHPMailer(true);
                        ...
                        $mail->Body = 'Password reset link <b><a href="http://localhost/411/change-password.php?reset='.$otp.'">http://localhost/411/change-password.php?reset='.$otp.'</a></b>';
                        $mail->AltBody = 'Password reset link <b><a href="http://localhost/411/?verification='.$otp.'">http://localhost/411/?verification='.$otp.'</a></b>';
