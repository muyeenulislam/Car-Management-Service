...
<body>
    ...
    <section class="section about" id="about">
        ...
        <div class="title-wrapper">
            <h2 class="title"><span class="subtitle">Rent Car</span></h2>
        </div>
        <!--end of title-->

        <?php
						include 'config.php';
						$sel = "SELECT * FROM rent_car WHERE crsku = '$_GET[crsku]'";
						$rs = $conn->query($sel);
						$rws = $rs->fetch_assoc();
			?>
        <!--about center-->
        <div class="about-center section-center">
            ...
            <article class="about-img">
                <img src="rentimg/<?php echo $rws['car_img'];?>" class="about-photo" alt="paint">
            </article>
            <!--about info-->
            <article class="about-info">
                ...
                <p><?php echo '<b>Price: BDT</b> '.$rws['price'].'<b> per hour</b> ';?></p>
            ...
            if($rws['quantity']<1){
                ...
                ?>
                        <div class="art-link">
                            <a href="rentpaynow.php?crsku=<?php echo $rws['crsku'] ?>&price=<?php echo $rws['price'] ?> " target="_blank" class="btn-primary">Proceed</a></t>
                        </div>
                    </div>
                    <?php
            }
